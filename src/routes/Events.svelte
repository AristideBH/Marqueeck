<script>
	...
	const handleHoverIn = () => {
		console.log('▶️ Mouse entered Marqueeck !');
	};
	const handleHoverOut = () => {
		console.log('⏸️ Mouse leaved Marqueeck !');
	};
	const handleClick = () => {
		console.log('🖱️ Marqueeck has been clicked !');
	};
</script>
